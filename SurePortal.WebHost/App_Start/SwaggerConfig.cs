            ...
            .EnableSwagger(c =>
                {
                    ...
                    //{
                    //    var groupBy = apiDesc.RelativePath.Split(new char[] { '/' }, System.StringSplitOptions.RemoveEmptyEntries);

                    //    try
                    //    {
                    //        var name = "";
                    //        for (int idx = 1; idx < groupBy.Length - 1; idx++)
                    //        {
                    //            if (!groupBy[idx].StartsWith("{"))
                    //            {
                    //                name += groupBy[idx] + ".";
                    //            }
                    //            else
